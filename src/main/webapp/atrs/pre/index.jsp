		...
		<div class="bottom clearfix box-s">
			<div class="left clearfix fl">
				<div class="listone clearfix fl">
					<a href="${ctx}/ProductServlet?pid=${product2.id}&ty=commodit">
						<!--备注：第一张图 宽度：418像素，高度：710像素-->
						<div class="tu clearfix">
							<img src="${ctx}/atrs/statics/files/zuopin/${product2.imagePath}"/>
							<span></span>
						</div>
				...
				<div class="listone listtwo clearfix fl">
					<a href="${ctx}/ProductServlet?pid=${product1.id}&ty=commodit">
						<!--备注：第二张图 宽度：438像素，高度：376像素-->
						<div class="tu clearfix">
							<img src="${ctx}/atrs/statics/files/zuopin/${product1.imagePath}"/>
							<span></span>
						</div>
						<div class="listxia clearfix ta-center">
							<h2>
			...
			<div class="right clearfix fr">
				<div class="listone listthree clearfix fl">
					<a href="${ctx}/ProductServlet?pid=${product3.id}&ty=commodit">
						<!--备注：第三张图 宽度：530像素，高度：638像素-->
						<div class="tu clearfix">
							<img src="${ctx}/atrs/statics/files/zuopin/${product3.imagePath}"/>
							<span></span>
						</div>
						<div class="listxia clearfix ta-center">
							<h2>
				...
				<div class="listone listfour clearfix fr">
					<a href="${ctx}/ProductServlet?pid=${product4.id}&ty=commodit">
						<!--备注：第四张图 宽度：438像素，高度：480像素-->
						<div class="tu clearfix">
							<img src="${ctx}/atrs/statics/files/zuopin/${product4.imagePath}"/>
							<span></span>
						</div>
						<div class="listxia clearfix ta-center">
							<h2>
...
<div class="choice clearfix">
	...
	<div class="content clearfix box-s">
		...
		<c:forEach var="pro" items="${products}" begin="1" end="9">
			<div class="list clearfix transition">
				<div class="tu clearfix">
					<img src="${ctx}/atrs/statics/files/zuopin/${pro.imagePath}"/>
					<span></span>
				...
				<div class="xia clearfix box-s">
					...
					<div class="price clearfix">
						<span class="fl">￥${pro.current}</span>
						<a href="${ctx}/ProductServlet?pid=${pro.id}&ty=commodit" class="goumai fr ra3 transition">立即购买</a>
					</div>
				</div>
			</div>
		</c:forEach>
		...
		<div class="art-ctent clearfix box-s">
			...
			<div class="bottom clearfix box-s">
				<div class="scrollBox" style="margin:0 auto">
					<div class="ohbox">
						<ul class="piclist">
							<c:forEach var="list" items="${artist}" >
								<li>
									<div class="list clearfix fl box-s transition">
										<div class="tu clearfix box-s">
											<img src="${ctx}/atrs/statics/files/touxiang/${list.imagePath}"/>
											<span></span>
										</div>
										<div class="ctent clearfix box-s">
											<div class="shang clearfix">
												<p class="over ta-center">${list.name}</p>
												<span></span>
											</div>
